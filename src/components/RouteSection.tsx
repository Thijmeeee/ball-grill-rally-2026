...
const RouteSection = () => {
    ...
    const itinerary = [
        ...
        { day: "DAG 5 & 6", title: "DEMI-QUARTIER", km: 180, desc: "Na een heerlijke nacht in **Demi-Quartier**, met uitzicht op ==Mont Blanc==, hebben we hier een **rustdag**, de volgende dag zetten we  koers richting de Vogezen. De route begint met een rit door de **Haute-Savoie**, langs plaatsen als **Megève** en **Albertville**, waarna we via de Rhônevallei richting de Vogezen rijden.\n\nDe eindbestemming, **Saint-Maurice-sur-Moselle**, ligt aan de voet van de Ballon d'Alsace en is een ideale plek om de dag af te sluiten.", icon: MapPin },
